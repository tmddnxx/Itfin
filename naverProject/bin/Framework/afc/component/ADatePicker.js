...
ADatePicker.prototype.openPicker = function()
{
	...
	if(afc.isAndroid) this._show_android();
	else if(afc.isIos) this._show_ios();
	
	this.isPickerOpen = true;
};

ADatePicker.prototype._show_android = function()
{
	var thisObj = this;
...
ADatePicker.prototype._show_ios = function()
{
	var thisObj = this;
...
ADatePicker.prototype.setData = function(data)
{
	this.setValue(data);
};

ADatePicker.prototype.getData = function()
{
