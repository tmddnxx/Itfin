...
class AFlowOneLine extends AComponent
{
	constructor()
	{
		super();
...
window.AFlowOneLine = AFlowOneLine;

AFlowOneLine.CONTEXT = 
{
    tag: '<svg data-base="AFlowOneLine" data-class="AFlowOneLine" data-direct="horizon" data-arrow-position="start" data-linecolor="black" class="AFlowLine-Style">'+
		 	'<defs>'+
