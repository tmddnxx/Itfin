...
class AFlowTwoLine extends AComponent
{
	constructor()
	{
		super();
...
window.AFlowTwoLine = AFlowTwoLine;

AFlowTwoLine.CONTEXT = 
{
    tag: '<svg data-base="AFlowTwoLine" data-bending-value="100" data-class="AFlowTwoLine" data-direct="0" data-arrow-position="start" data-linecolor="black" class="AFlowLine-Style">'+
		 	'<defs>'+
