...
class AFlowThreeLine extends AComponent
{
	constructor()
	{
		super();
...
window.AFlowThreeLine = AFlowThreeLine;

AFlowThreeLine.CONTEXT = 
{
    tag: '<svg data-base="AFlowThreeLine" data-leaning-value="100" data-leaning-postion="true" data-class="AFlowThreeLine" data-direct="0" data-arrow-position="start" data-linecolor="black" class="AFlowLine-Style">'+
		 	'<defs>'+
