...
ACalendarPickerItem.prototype.openCalendar = function(left, top)
{
	...
	//모바일일 경우...
	if(afc.isPhone) this.calPopup.openCenter('Framework/mdfc/layout/ACalendarItem.html', null);
	else this.calPopup.open('Framework/mdfc/layout/ACalendarItem.html', null, pos.left, pos.top, 'auto', 'auto');
...
ACalendarPickerItem.prototype.openMonthSelector = function()
{
	...
	//모바일일 경우...
	if(afc.isPhone) this.calPopup.openCenter('Framework/mdfc/layout/ACalendarMonthItem.html', null);
	else this.calPopup.open('Framework/mdfc/layout/ACalendarMonthItem.html', null, pos.left, pos.top, 'auto', 'auto');	//, 220, 176
	this.doOpenBorderCss(true);	
	this.calPopup.setResultCallback(function(result)
	{
		//result is date
