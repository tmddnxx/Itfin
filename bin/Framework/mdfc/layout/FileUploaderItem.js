...
*/
class FileUploaderItem extends AView
{
    constructor()
    {
        super()
...
window.FileUploaderItem = FileUploaderItem

FileUploaderItem.prototype.init = function(context, evtListener)
{
	AView.prototype.init.call(this, context, evtListener);

	FileUploaderItem.thisObj = this;
...
//초기화
FileUploaderItem.prototype.removeAll = function()
{
...
FileUploaderItem.prototype.formatBytes = function(a, b)
{
...
//파일 찾기 클릭시...
FileUploaderItem.prototype.onFindBtnClick = function(acomp, info)
{
...
FileUploaderItem.prototype.onInputFileChange = function(files)
{
...
//업로드 URL 가져오기
FileUploaderItem.prototype.getUrl = function()
{
	return this.$ele.parent().parent().attr('data-upload-url');
};

//파일타입 종류 가져오기
FileUploaderItem.prototype.getAllAcceptType = function()
{
...
//파일찾기 타입 선택
FileUploaderItem.prototype.setAccept = function(type)
{
	this.accept = type;
...
//다중첨부 여부 [true|false]
FileUploaderItem.prototype.setMultiple = function(bln)
{
	this.multiple = bln;
};
...
//드래그드랍 여부 [true|false]
FileUploaderItem.prototype.setDragdrop = function(bln)
{
	this.dragdrop = bln;
};
...
//전송 여부
FileUploaderItem.prototype.getSize = function()
{
	return this.sendSize;
};


FileUploaderItem.prototype.getFilesInfo = function()
{
...
FileUploaderItem.prototype.send = function(data, callback)
{
...
//formData 파일전송
FileUploaderItem.prototype.formdataSend = function(data, callback)
{
...
//iframe 파일전송
FileUploaderItem.prototype.iframeSend = function(data, callback)
{
	var markers,
